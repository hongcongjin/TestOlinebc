...
from app.users.views import LoginView,  RegisterView,userviews,LogoutView
from app.operation.views import index,PaperListView,PaperView,SelectView,TrainView
from app.TOBC.views import history
urlpatterns = [
